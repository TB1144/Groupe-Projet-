...
- [ ] **SFx 7** : Rechercher et afficher une offre de stage.
- [ ] **SFx 8** : Créer une offre de stage.
- [ ] **SFx 9** : Modifier une offre de stage.
- [ ] **SFx 10** : Supprimer une offre de stage.
...
- [ ] **SFx 27** : Pagination sur les affichages de listes (utilisateurs, entreprises, offres).
- [ ] **SFx 28** : Mentions légales (conformité RGPD).
- [ ] **Bonus** : Accès mobile PWA (Progressive Web App).
...
- [ ] **STx 8** : Utilisation de clés étrangères dans le SGBD.
